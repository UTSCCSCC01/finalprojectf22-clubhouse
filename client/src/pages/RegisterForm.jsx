    ...
    return (
      <Container>
        ...
        <Grid container direction="column" style={{ textAlign: "center", marginBottom: "110px" }}>
          ...
          <Grid item>
            <TextField error={ee} helperText={this.state.eerror} margin="normal" id="email" label="Email" variant="outlined" style={{ width: 350 }} onChange={this.handleTextFieldChange} />
          </Grid>
          <Grid item>
            <TextField error={pe} helperText={this.state.pwerror} type="password" margin="normal" id="password" label="Password" variant="outlined" style={{ width: 350 }} onChange={this.handleTextFieldChange} />
          </Grid>
          <Grid item>
            <TextField type="password" margin="normal" id="passwordC" label="Confirm Password" variant="outlined" style={{ width: 350 }} onChange={this.handleTextFieldChange} />
          </Grid>
          <Grid item>
          ...
          {!this.state.showVerification ? null : (
            <div>
              <Grid item>
                <TextField type="number" error={ce} helperText={this.state.scerror} margin="normal" id="code" label="Code" variant="outlined" style={{ width: 350 }} onChange={this.handleTextFieldChange} />
              </Grid>
              <Grid item>
                <Typography style={{ paddingTop: 50 }} variant="caption" align="center">Please enter emailed code</Typography>
              </Grid>
              <Grid item>
                <Button variant="contained" color="primary" style={{ width: 350, marginTop: 25 }} onClick={this.submitCode}>Submit Code</Button>
              </Grid>
            </div>
          )}
        </Grid>
